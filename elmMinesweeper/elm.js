...
Elm.Model.make = function (_elm) {
   ...
   var Mine = {ctor: "Mine"};
   var Reveal = function (a) {    return {ctor: "Reveal",_0: a};};
   var AppState = F4(function (a,b,c,d) {    return {board: a,rows: b,columns: c,mines: d};});
   return _elm.Model.values = {_op: _op,AppState: AppState,Reveal: Reveal,Mine: Mine,Clear: Clear,Box: Box};
};
Elm.Utils = Elm.Utils || {};
...
Elm.View.make = function (_elm) {
   ...
   var boxView = F2(function (address,box) {
      if (box.isRevealed) {
         ...
         } else return A2($Html.td,_U.list([hiddenBoxStyle,A2($Html$Events.onClick,address,$Model.Reveal(box))]),_U.list([]));
   });
